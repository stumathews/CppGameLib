...
int main(int argc, char **argv)
{
	...
	const shared_ptr<gamelib::resource_manager> resource_admin(new gamelib::resource_manager(global_config, graphics_admin, font_admin, audio_admin ));
		resource_admin->initialize(event_admin);
	const shared_ptr<gamelib::scene_manager> scene_admin(new gamelib::scene_manager(event_admin, global_config, resource_admin));
