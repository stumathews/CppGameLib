...
namespace gamelib
{
	MovementAtSpeed::MovementAtSpeed(const int speed, const Direction direction, const unsigned int deltaMs): speed(speed), direction(direction), deltaMs(deltaMs)
	{
	}
