...
namespace gamelib
{
	...
	public:	
		...
		[[nodiscard]] static std::shared_ptr<StaticSprite> BuildGraphic(
			const std::shared_ptr<Asset>& asset, const Coordinate<int>& position);
		...
		[[nodiscard]] static std::shared_ptr<StaticSprite> BuildStaticSprite(
			const std::shared_ptr<Asset>& asset, const Coordinate<int>& position);
	...
	private:
		...
		static void OnBlueParse(uint& blue, const std::string& detailValue);

		static void OnGreenParse(uint& green, const std::string& detailValue);

		static void OnRedParse(uint& red, const std::string& detailValue);
		static void OnColourKeyParse(bool& color_key_enabled, const std::string& detailValue);

		static void OnPosYParse(uint& y, const std::string& detailValue);
		static void OnVisibleParse(bool& visible, const std::string& detailValue);

		static void OnPosXParse(uint& x, const std::string& detailValue);
		...
		[[nodiscard]] static std::shared_ptr<GameObject> InitializeGameObject(const std::string& name, const std::string& type, Coordinate<int> position, bool IsVisible,
