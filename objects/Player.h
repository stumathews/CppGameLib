...
namespace gamelib
{
	...
	public:
		...
		player(int x, int y, int w, int h, std::shared_ptr<resource_manager> resource_admin, std::shared_ptr<settings_manager> settings_admin, std::shared_ptr<event_manager> event_admin);
		...
		static int get_room_neighbour_index(int first_room_index, int last_room_index, int side, std::shared_ptr<square> room);
